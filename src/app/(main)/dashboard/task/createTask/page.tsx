...
const CreateTaskPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Create subtasks
            await Promise.all(subtasks.map(subtaskTitle =>
                createSubTask({
                    taskId: newTask.id,
                    title: subtaskTitle,
            ...
            <div className="mx-auto max-w-4xl space-y-8 p-6 sm:p-8">
                <Card className="overflow-hidden border-none bg-gradient-to-r from-primary/5 via-primary/10 to-background shadow-xl">
                    <div className="relative p-6 sm:p-8">
                        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl bg-gradient-to-r from-primary/90 to-primary bg-clip-text text-transparent mb-8">
                            Create New Task
                        </h1>
