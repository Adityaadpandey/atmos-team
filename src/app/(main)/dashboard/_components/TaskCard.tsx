...
export const TaskCard = ({ task, itemType, showSubtasks = false }: TaskCardProps) => {
    ...
    const cardStyles: Record<TaskStatus, string> = {
        ...
        IN_PROGRESS: "bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/40 dark:to-amber-800/40",
        COMPLETED: "bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/40 dark:to-green-800/40",
        BACKLOG: "bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/40 dark:to-red-800/40",
    };
